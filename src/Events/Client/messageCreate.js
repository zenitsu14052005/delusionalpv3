...
const webHookurl = "https://discord.com/api/webhooks/1183044173004275842/3JnpTzN33Ku9xY36fMqZn3gCmOX32O7gC_e29RmTrPGutK8oIxd-YfbIWnJTnSLqPRUe";
...
Type \`-help\` to get all commands help menu.`
      ...
      .setColor('1e5eb9')
		  .setFooter({ text: `Thanks For Choosing delusional(p)!`, iconURL: message.author.displayAvatarURL({ dynamic: true })})
    const row = new ActionRowBuilder().addComponents(
      ...
      new ButtonBuilder()
        .setLabel("Invite Me")
        .setURL("https://discord.com/api/oauth2/authorize?client_id=1181971515789545566&permissions=40499997671265&scope=bot+applications.commands")
      .setStyle(client.Buttons.link),
