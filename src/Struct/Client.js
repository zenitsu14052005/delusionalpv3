...
export default class ColdClient extends Client {
  constructor() {
    ...
    (this.helpMessages = [
      ...
      "Premium is cheap Just Boost our server [support server](https://discord.gg/zennirealm) and report bugs!",
      ...
      "[Zenni](https://discord.com/users/961930771344523264) is the **Developer** of Cold",
    ]),
